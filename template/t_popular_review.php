...
<title>人気のレビュー：<?php echo html($d_site_title);?></title>
...
<h1 class="page_title">人気のレビュー</h1>

<p style="text-align:right; font-size:x-small"><img src="img/list_marker_red.gif" border="0"><a href="new_review.php">新着レビュー</a> / <a href="popular_book.php">人気の本</a></p>
