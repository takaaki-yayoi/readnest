...
<title>新着レビュー：<?php echo html($d_site_title);?></title>
...
<h1 class="page_title">新着レビュー</h1>

<p style="text-align:right; font-size:x-small"><img src="img/list_marker_red.gif" border="0"><a href="popular_review.php">人気のレビュー</a> / <a href="popular_book.php">人気の本</a></p>
